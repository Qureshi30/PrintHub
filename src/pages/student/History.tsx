        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="space-y-4">
            {jobs.map((job) => {
              ...
              const cost = pages * (job.settings?.copies || 1) * (job.settings?.color ? 0.15 : 0.05);
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground">
                            <span className="flex items-center gap-1">
                              ...
                              {/* printerId can be either string ID or populated Printer object */}
                              Printer {typeof job.printerId === 'string' 
                          ...
                          <div className="flex items-center gap-1 text-xs text-muted-foreground">
                            ...
                            {job.status === 'completed' && (
                              <span className="ml-2">
                                • Completed: {formatDate(job.timing?.completedAt || job.timing?.updatedAt || new Date())}
                              </span>
                            )}
                          </div>
                        </div>
